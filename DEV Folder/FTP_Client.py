...
def main():
    ...
    print("Results of Type I: " + command_socket.recv(8192).decode())
    data_socket = passiveConnect(command_socket)

    command_socket.send('RETR testImage.jpg\r\n'.encode())
    print("Results of RETR command: " + command_socket.recv(8192).decode())

    file_data = data_socket.recv(8192)
    f = open("testImage1.jpg", 'wb')
    ...
    command_socket.send('STOR mo.jpg\r\n'.encode())
    print("Results of STOR command: " + command_socket.recv(8192).decode())
